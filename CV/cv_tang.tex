...
\pubgroup{
    \manWithNum{Transactional Panorama: A Conceptual Framework for User Perception in Analytical Visual Interfaces}
    	...
    	\> \textbf{Under Revision at VLDB}\\[5mm]
    ...
    \manWithNum{Efficient and Compact Spreadsheet Formula Graphs}
    	...
    	\> \textbf{Under Revision at ICDE}\\[5mm]
...
\projectWithNumUrl{FormS: A Python Library for Scalable Spreadsheet Formula Execution}{Mar. 2022-Present}
...
\projectWithNumUrl{Transactional Panorama: Enhancing User Perception in Analytical Interfaces}{Sep. 2021-Present}
...
\projectWithNumUrl{Taco: Efficient and Compact Spreadsheet Formula Graphs}{Jan. 2021-Present}
...
{https://github.com/totemtang/cc-testbed}
