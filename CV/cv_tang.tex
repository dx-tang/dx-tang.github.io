...
\pubgroup{
    \pub{\textbf{Dixin Tang}, Zechao Shang, Aaron J. Elmore, Sanjay Krishnan, Michael J. Franklin:}
       \> Thrifty Query Execution via Incrementability \\
       \> \textbf{SIGMOD 2020} \\[5mm]

    \pub{Zechao Shang, Xi Liang, \textbf{Dixin Tang}, Cong Ding, Aaron J. Elmore, Sanjay Krishnan, Michael J. Franklin:}
    ...
    \pub{Panagiotis Antonopoulos, Alex Budovski, Cristian Diaconu, Alejandro Hernandez Saenz, Jack Hu, \\ 
    ...
    \pub{\textbf{Dixin Tang}, Aaron J. Elmore:}
